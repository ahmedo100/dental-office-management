...
<head>
    ...
    <title>Medicare - Medical & Hospital - Bootstrap 4 Admin Template</title>
    ...
    <script>
        ...
        function addAppointment(){
            ...
            $.ajax({
                url : './engine/ajax.php',
                type : 'POST',
                data: { "type": "editAppointment",
                    "id-appointment": <?php echo $_GET["id_appointment"]; ?>,
                ...
                success : function(data){
                    ...
                    if($.trim(data)== "updated") {
                        alert("rendez-vous modifier avec succés");
        ...
        $( document ).ready(function() {
            $.ajax({
                url : './engine/ajax.php',
                type : 'POST',
                data: { "type": "getAppointment",
                    "id-appointment": <?php echo $_GET["id_appointment"]; ?>,
                },
                success : function(data){
                    $("#patient-name").text(JSON.parse(data)["full_name_patient"]);
                    document.getElementById("date-appointment").value = JSON.parse(data)["date_appointment"];
                    document.getElementById("datetimepicker3").value = JSON.parse(data)["hour_appointment"]+" AM";
                    document.getElementById("message-appointment").value = JSON.parse(data)["message_appointment"];
        ...
        <div class="content">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h4 class="page-title">Modification du Rendez-vous de : <span id="patient-name"></span></h4>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
