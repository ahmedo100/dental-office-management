            ...
            <ul class="nav user-menu float-right">
                ...
                <li class="nav-item dropdown has-arrow">
                    <a href="#" class="dropdown-toggle nav-link user-link" data-toggle="dropdown">
                        <span class="user-img"><img class="rounded-circle" src="http://wikinetworth.com/uploads/images/edward-snowden.jpg" width="40" alt="Admin">
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-patient.html" class="add-button  float-right"><i class="fa fa-plus"></i> Ajouter un patient</a>
                    </div>
                </div>
