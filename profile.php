            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-7 col-6">
                        <h4 class="page-title">Profil patient</h4>
                    </div>

                    <div class="col-sm-5 col-6 text-right m-b-30">
                        <a href="edit-profile.html" class="btn btn-primary btn-rounded"><i class="fa fa-edit"></i> Modifier le Profil</a>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="profile-view">
                                ...
                                <div class="profile-basic">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php displayProfileInfo($_GET["id_patient"]); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>                        
				...
				<div class="profile-tabs">
					<ul class="nav nav-tabs nav-tabs-bottom">
						<li class="nav-item"><a class="nav-link active" href="#about-cont" data-toggle="tab">Rendez-vous</a></li>
						<li class="nav-item"><a class="nav-link" href="#bottom-tab2" data-toggle="tab">Ordonnances</a></li>
						<li class="nav-item"><a class="nav-link" href="#bottom-tab3" data-toggle="tab">Notes</a></li>
					</ul>
